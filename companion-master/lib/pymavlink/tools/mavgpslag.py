...
-  On copter (bit0, bit2 and bit18) set on the LOG_BITMASK _parameters
-  On rover  (bit0, bit2 and bit7) set on the LOG_BITMASK _parameters
-  On plane  (bit0, bit2 and bit7) set on the LOG_BITMASK _parameters
