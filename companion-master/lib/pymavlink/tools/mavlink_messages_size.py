...
(                             'PARAM_VALUE' ,  33), # ID#022 Emit the value of a onboard parameter. The inclusion of param_count and param_index in the message allows the recipient to keep track of received _parameters and allows him to re-request missing _parameters after a loss or timeout.
...
(                            'PARAM_MAP_RC' ,  45), # ID#050 Bind a RC channel to a parameter. The parameter should change accoding to the RC channel value.
(                     'MISSION_REQUEST_INT' ,  12), # ID#051 Request the information of the mission item with the sequence number seq. The response of the system to this message should be a MISSION_ITEM_INT message. http://qgroundcontrol.org/mavlink/waypoint_protocol
...
(                             'COMMAND_ACK' ,  11), # ID#077 Report status of a command. Includes feedback wether the command was executed.
...
(                                'WIND_COV' ,  48), # ID#231 
(                               'GPS_INPUT' ,  71), # ID#232 GPS sensor input message.  This is a raw sensor value sent by the GPS. This is NOT the global position estimate of the sytem.
